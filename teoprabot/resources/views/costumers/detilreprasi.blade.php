...
<div class="container mt-5">
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    @elseif($detilreprasi->status == 'ditolak')
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <a href="https://wa.me/6281266667757" target="_blank" class="btn btn-success">
                <i class="bi bi-whatsapp"></i> Chat via WhatsApp
            </a>
            <a href="{{route('indexreprasi')}}" class="btn btn-danger">Back</a>
