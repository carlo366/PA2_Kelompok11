...
<!--Form Add Gallery  -->
<div class="modal fade text-left" id="tambahGallery" tabindex="-1" role="dialog"
aria-labelledby="myModalLabel33" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
        <div class="modal-header">

            <h4 class="modal-title" id="myModalLabel33">Tambah Gallery</h4>
                    ...
                    <form action="{{ route('storeGallery') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" placeholder="Nama Gallery" class="form-control" required oninput="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1);" autofocus>
                            </div>

                            <label>Gambar</label>
                            <div class="form-group">
                                <input type="file" name="image" placeholder="Nama Gallery" class="form-control" required >
                            </div>
...
<div class="main-content container-fluid">
    <div class="page-title">
        ...
        <div class="pb-3 pt-4"><button type="button" class="btn btn-success p-3"  data-bs-toggle="modal" data-bs-target="#tambahGallery"> Tambah Gallery</button></div>
    </div>
