        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('semua-slider')}}">slider</a></li>
        ...
        <div class="card">
            <form action="{{ route('updateslider', ['id' => $slider->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="col-sm-4">
                        <h6>Nama Slider</h6>
                        <input class="form-control form-control-lg" type="text" value="{{ $slider->name }}" name="name" placeholder="Nama Slider">
                        <br>
                        <img src="{{ asset($slider->gambar) }}" alt="" style="max-width: 100%; height: auto;">
                        <br>
