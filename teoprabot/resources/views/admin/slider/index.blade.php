            ...
            <h4 class="modal-title" id="myModalLabel33">Tambah Slider</h4>
                    ...
                    <form action="{{ route('storeslider') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <label>Gambar</label>
                            <div class="form-group">
                                <input type="file" name="gambar" placeholder="Nama Slider" class="form-control" required >
                            </div>
                ...
                <table class='table table-striped' id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{$slid->name}}</td>
                            <td><img src="{{asset($slid->gambar)}}" style="width: 5em;" alt=""></td>
                            <td>
                                <a href="{{route('editslider', $slid->id_categories)}}" class="btn btn-warning">Edit</a>
                                <a href="#" onclick="confirmDelete('{{ $slid->id_categories }}')" data-name="" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
